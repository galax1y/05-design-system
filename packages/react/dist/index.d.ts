...
declare const Provider: _stitches_react_types_styled_component.StyledComponent<react.FC<Tooltip$1.TooltipProviderProps>, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
